...
<link rel="stylesheet"
	href="${resource(dir: 'uaassets/css/pages', file: 'error-rtl.css')}"
	type="text/css" />
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<h3 class="page-title">שגיאה 404</h3>
				<ul class="breadcrumb">
		...
		<div class="row-fluid">
			<div class="span12 page-404">
				...
				<div class="details">
					...
					<p>
						אין ביכולתינו למצוא את הדף שאתה מחפש.<br /> <a
							href="index-2.html">חזור לדף הבית</a> או נסה את החיפוש מטה.
					</p>
					<form action="#">
						<div class="input-append">
							<input class="m-wrap" size="16" type="text"
								placeholder="keyword..." />
