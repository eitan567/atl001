			...
			.extend(
					a.validator,
					{
						...
						messages : {
							...
							remote : "אנא תקן את הערך בשדה.",
							email : "אנא הזן כתובת דואר אלקטרוני תקנית.",
							url : "אנא הזן כתובת URL תקנית.",
							date : "אנא הזן תאריך תיקני.",
							dateISO : "אנא הזן תאריך תיקני (ISO).",
							number : "אנא הזן מספר תיקני.",
							digits : "אנא הזן ספרות בלבד.",
							creditcard : "אנא הזן מספר כרטיס אשראי תיקני.",
							equalTo : "אנא הזן ערך זה שנית.",
							maxlength : a.validator
									.format("אנא הזן יותר מ {0} תוים."),
							minlength : a.validator
									.format("אנא הזן לפחות  {0} תווים."),
							rangelength : a.validator
									.format("אנא הזן ערך בין  {0} ל-{1} תווים."),
							range : a.validator
									.format("אנא הזן ערך בין {0} ל-{1}."),
							max : a.validator
									.format("אנא הזן ערך קטן או שווה ל-{0}."),
							min : a.validator
									.format("אנא הזן ערך גדול או שווה ל-{0}.")
						},
